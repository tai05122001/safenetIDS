...
class Level1PredictionService:
    ...
    def __init__(self,
                 ...
                 input_topic='preprocessed_events',
                 output_topic='level1_predictions',
...
def main():
    ...
    parser.add_argument('--input-topic', default='preprocessed_events',
                       help='Input topic name')
    parser.add_argument('--output-topic', default='level1_predictions',
