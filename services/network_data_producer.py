...
class NetworkDataProducer:
    ...
    def __init__(self, kafka_bootstrap_servers='localhost:9092', topic='raw_data_event'):
        """
...
Examples:
  ...
  python network_data_producer.py --kafka-servers kafka:9092       # Custom Kafka servers
    ...
    parser.add_argument('--historical-data', default='services/data/test_samples.csv',
                       help='Path to CSV file with historical data for testing (default: services/data/test_samples.csv)')
    ...
    try:
        ...
        logger.info(f"Configuration: servers={args.kafka_servers}, topic={args.topic}, interval={args.interval}s, historical_data={args.historical_data}")
